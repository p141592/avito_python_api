...
def test_autoteka_vehicle_flows() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        if path == "/autoteka/v1/catalogs/resolve":
            ...
            return httpx.Response(
                200,
                json={"result": {"fields": [{"id": 110000, "label": "Марка", "dataType": "integer", "values": [{"valueId": 1, "label": "Audi"}]}]}},
            )
        ...
        if path == "/autoteka/v1/previews/77":
            return httpx.Response(
                200,
                json={"result": {"preview": {"previewId": 77, "status": "success", "vin": "VIN-1", "regNumber": "A123AA77"}}},
            )
        ...
        if path == "/autoteka/v1/specifications/specification/501":
            return httpx.Response(
                200,
                json={"result": {"specification": {"specificationId": 501, "status": "success", "vehicleId": "VIN-1", "plateNumber": "A123AA77"}}},
            )
        ...
        return httpx.Response(
            200,
            json={"teaserId": 601, "status": "success", "data": {"brand": "Audi", "model": "A4", "year": 2018}},
        )
    ...
    preview_external = vehicle.create_preview_by_external_item(payload={"itemId": "ext-1", "site": "cars.example"})
    preview = vehicle.get_preview()
    specification_plate = vehicle.create_specification_by_plate_number(payload={"plateNumber": "A123AA77"})
    specification_vehicle = vehicle.create_specification_by_vehicle_id(payload={"vehicleId": "VIN-1"})
...
def test_autoteka_report_monitoring_scoring_and_valuation_flows() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        if path == "/autoteka/v1/reports/701":
            return httpx.Response(
                200,
                json={"result": {"report": {"reportId": 701, "status": "success", "webLink": "https://autoteka/web/701", "pdfLink": "https://autoteka/pdf/701", "data": {"vin": "VIN-1"}}}},
            )
        ...
        if path == "/autoteka/v1/monitoring/get-reg-actions/":
            ...
            return httpx.Response(
                200,
                json={"data": [{"vin": "VIN-1", "brand": "Audi", "model": "A4", "year": 2018, "operationCode": 11, "operationDateFrom": "2026-04-01T00:00:00+03:00"}], "pagination": {"hasNext": True, "nextCursor": "cursor-2", "nextLink": "https://api.avito.ru/next"}},
            )
        ...
        return httpx.Response(
            200,
            json={"result": {"status": "success", "vehicleId": "VIN-1", "brand": "Audi", "model": "A4", "year": 2018, "ownersCount": "2", "mileage": 30000, "valuation": {"avgPriceWithCondition": 2100000, "avgMarketPrice": 2200000}}},
        )
    ...
    valuation_item = valuation.get_valuation_by_specification(payload={"specificationId": 501, "mileage": 30000})
